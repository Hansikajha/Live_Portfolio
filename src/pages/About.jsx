            ...
            <div className="max-w-2xl mx-auto">
              <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-8 border border-blue-100">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-900">BSc in Computer Science</h3>
                    <p className="text-gray-600 font-medium">State University</p>
                    <p className="text-gray-500 text-sm mt-1">2015 - 2019 • Graduated with Honors</p>
...
function SkillCard({ icon, title, skills, gradient }) {
  return (
    <div className={`bg-gradient-to-br ${gradient} rounded-2xl p-6 border border-gray-200 hover:shadow-lg transition-all duration-300 group`}>
      <div className="flex items-center mb-4">
        <div className="bg-white p-3 rounded-xl shadow-sm group-hover:scale-110 transition-transform duration-300">
          {icon}
        </div>
        <h3 className="font-bold text-gray-900 text-lg ml-4">{title}</h3>
      </div>
...
function ExperienceItem({ role, company, duration, description, year }) {
  return (
    <div className="flex gap-6 group">
      ...
      {/* Content */}
      <div className="flex-1 bg-white rounded-2xl p-6 border border-gray-200 hover:shadow-lg transition-all duration-300 group-hover:border-blue-200">
        <div className="flex flex-col md:flex-row md:justify-between md:items-start mb-3">
          <h3 className="font-bold text-gray-900 text-lg">{role}</h3>
          <span className="text-blue-600 font-medium text-sm bg-blue-50 px-3 py-1 rounded-full mt-2 md:mt-0">
            {duration}
          </span>
        </div>
